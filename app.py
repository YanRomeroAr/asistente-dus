...
# ---------------------------
st.set_page_config(page_title="Asistente DUS", page_icon="🤖", layout="centered")
...
st.markdown("Haz tus consultas sobre la Ley de Desarrollo Urbano Sostenible (Ley N° 31313) y obtén respuestas claras y rápidas.")
